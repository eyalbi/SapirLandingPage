          ...
          <div>
            ...
            <div className="border-r-2 border-sage-light pr-5 mb-6">
              <h3 className="text-base font-semibold text-charcoal mb-3">
                הדרך שלי אל שיטת סאטיה
              </h3>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                לאורך השנים ליוותה אותי תחושה פנימית של “חייב להיות יותר
                מזה”.
              </p>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                ...
                <br />
                (מתוך שירו של פרדי מרקיורי)
              </p>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                הרגשתי שאני יכולה לעשות דברים אחרת, שאני לא צריכה להיות
                הנסיבות של חיי. למרות תנועה, עשייה וחיים מלאים כלפי חוץ – עלו
                בי שאלות, חוסר שקט ורצון להבין לעומק מה מניע אותי ואת האנשים
                סביבי.
              </p>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                מצאתי את עצמי נמשכת לשיחות עמוקות, להקשבה למה שנאמר ולא נאמר
                במילים, ולתחושות שעולות בגוף תוך כדי מפגש.
              </p>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                דרך החיים וההתנסויות האישיות שלי הובילו אותי להבין שדווקא
                מקומות הכיווץ, הבלבול, העייפות והכאב – כפי שאני קוראת להם
                “כאבי גדילה” – הם שערים להתפתחות.
              </p>
              <p className="text-warm-gray text-sm leading-relaxed mb-3">
                המפגש עם שיטת סאטיה היה עבורי רגע של נחת. שפה שמאפשרת לעצור,
                לשהות, לבחור בהוויה שבה אני רוצה להיות. שפה שעזרה ותמכה בי
                לצאת מתוך תגובתיות ולחזור אל הגוף כמקום של אמת.
              </p>
              <p className="text-warm-gray text-sm leading-relaxed">
                מתוך החוויה האישית הזאת בחרתי להתמחות בשיטת סאטיה וללוות
                אחרים בתהליך דומה – תהליך של חיבור, אחריות ורכות כלפי עצמם.
              </p>
            </div>
          </div>
